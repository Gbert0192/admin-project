  ...
  theme: {
    extend: {
      colors: {
        ...
        "custom-gray-text": "var(--custom-gray-text)",
        "custom-gray-border": "var(--custom-gray-border)",
        "custom-page-bg": "var(--custom-page-bg)",
        "custom-footer-bg": "var(--custom-footer-bg)",
        "custom-link-blue": "var(--custom-link-blue)",
